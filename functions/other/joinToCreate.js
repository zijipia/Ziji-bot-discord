...
module.exports.execute = async (oldState, newState, guildSetting) => {
    ...
    if (newState.channelId === guildSetting.joinToCreate.voiceChannelId) {
        ...
        const managerEmbed = new EmbedBuilder()
            ...
            .setDescription(
                `Xin chào **${newState.member.user.username}**! Hãy sử dụng các nút để điều khiển phòng thoại nhé`
            )
            .setColor("Random")
        ...
        const row1 = new ActionRowBuilder().addComponents(
            new ButtonBuilder()
                .setCustomId("B_TempVoice_Lock")
                .setLabel("🔒 Khóa/Mở khóa")
                .setStyle(ButtonStyle.Primary),
            new ButtonBuilder()
                .setCustomId("B_TempVoice_Hide")
                .setLabel("👁️ Ẩn/Hiện kênh thoại")
                .setStyle(ButtonStyle.Primary),
            new ButtonBuilder()
                .setCustomId("B_TempVoice_Kick")
                .setLabel("👢 Đuổi người dùng")
                .setStyle(ButtonStyle.Danger),
            new ButtonBuilder()
                .setCustomId("B_TempVoice_Limit")
                .setLabel("👥 Giới hạn người dùng")
                .setStyle(ButtonStyle.Secondary),
            new ButtonBuilder()
                .setCustomId("B_TempVoice_Rename")
                .setLabel("✏️ Đổi tên")
